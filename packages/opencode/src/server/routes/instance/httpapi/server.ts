...
import { relayRoutes } from "../../relay/index"
...
export function createRoutes(
  ...
  return Layer.mergeAll(rootApiRoutes, eventApiRoutes, ptyConnectApiRoutes, instanceRoutes, docRoute, uiRoute, relayRoutes).pipe(
    Layer.provide([
      errorLayer,
      compressionLayer,
      corsVaryFix,
