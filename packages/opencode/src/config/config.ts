  ...
  compaction: Schema.optional(
    Schema.Struct({
      ...
      head_turns: Schema.optional(NonNegativeInt).annotate({
        description:
          "Number of earliest user turns, including their following assistant/tool responses, to keep verbatim during compaction (default: 2)",
      }),
      tail_turns: Schema.optional(NonNegativeInt).annotate({
        description:
          "Number of recent user turns, including their following assistant/tool responses, to keep verbatim during compaction (default: 0)",
      }),
