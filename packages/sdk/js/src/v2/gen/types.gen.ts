...
export type QueueStatusResponse = {
  ...
  rings: Array<number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN">
}
...
export type SyncEventSessionProxyState = {
  type: "sync"
  id: string
  syncEvent: {
    type: "session.proxy_state.1"
    id: string
    seq: number
    aggregateID: string
    data: {
...
export type EventSessionProxyState = {
  id: string
  type: "session.proxy_state"
  properties: {
    sessionID: string
...
export type AppAgentsRegisterData = {
  body?: AgentRegisterPayload
  path?: never
  query?: never
  url: "/agent/register"
}

export type AppAgentsRegisterErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type AppAgentsRegisterError = AppAgentsRegisterErrors[keyof AppAgentsRegisterErrors]

export type AppAgentsRegisterResponses = {
  /**
   * Agent registered
   */
  200: unknown
...
export type AppAgentsUnregisterData = {
  body?: string
  path?: never
  query?: never
  url: "/agent/unregister"
}

export type AppAgentsUnregisterErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type AppAgentsUnregisterError = AppAgentsUnregisterErrors[keyof AppAgentsUnregisterErrors]

export type AppAgentsUnregisterResponses = {
  /**
   * Agent unregistered
   */
  200: unknown
...
export type SessionForeverData = {
  body?: never
  path: {
    sessionID: string
  }
  ...
  url: "/session/{sessionID}/forever"
}

export type SessionForeverErrors = {
  /**
   * BadRequest | InvalidRequestError
   */
  400: EffectHttpApiErrorBadRequest | InvalidRequestError
...
export type SessionForeverError = SessionForeverErrors[keyof SessionForeverErrors]

export type SessionForeverResponses = {
  /**
   * Forever mode loop result
   */
  200: {
    info: Message
    parts: Array<Part>
...
export type SessionForeverResponse = SessionForeverResponses[keyof SessionForeverResponses]
...
export type QueuePushData = {
  body?: QueuePushPayload
  path?: never
  query?: never
  url: "/queue/message"
}

export type QueuePushErrors = {
  /**
   * InvalidRequestError
   */
...
export type QueuePushError = QueuePushErrors[keyof QueuePushErrors]

export type QueuePushResponses = {
  /**
   * QueuePushResponse
   */
  200: QueuePushResponse
}

export type QueuePushResponse2 = QueuePushResponses[keyof QueuePushResponses]
...
export type QueueStatusResponse2 = QueueStatusResponses[keyof QueueStatusResponses]
